...
-- Convenience entry-point if you want to call from elsewhere
...
-- 		.new(opts, {
-- 			prompt_title = "Path to executable",
-- 			finder = finders.new_oneshot_job({ "fd", "--hidden", "--no-ignore",	"-E '*/obj'", ".dll" }, {}),
-- 			sorter = conf.generic_sorter(opts),
-- 			attach_mappings = function(buffer_number)
-- 				actions.select_default:replace(function()
-- 					print("came")
...
--
-- 	print("hello")
-- 	return require("config.features.dotnet.startup").get_project()
--   -- require("config.features.dotnet.startup").debug()
-- end
--
